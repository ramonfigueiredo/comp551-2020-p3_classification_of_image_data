...
Status PrintTopLabels(const std::vector<Tensor>& outputs,
  ...
  int first_label = first_label = indices_flat(0);
  // for (int pos = 0; pos < how_many_labels; ++pos) {
  //   const int label_index = indices_flat(pos);
  //   first_label = indices_flat(0);
  //   const float score = scores_flat(pos);
  //   LOG(INFO) << labels[label_index] << " (" << label_index << "): " << score;
  // }


    // LOG(INFO) << "the class is "<<labels[first_label] ;

  myfile <<labels[first_label]<<"\n";
...
/*
  ...
  */
  ...
  string file_path = tensorflow::io::JoinPath(root_dir, image);
  file_path = file_path + "prediction.csv";
  // myfile.open ("/Users/WangYue/Desktop/COMP551/A3/Data/example.csv");
  myfile.open (file_path);

  myfile << "id,class\n";

/*
  *        wrap the procedure in a for loop:
  */

// the number of test samples:
  int  number_test_samples = 6600;
...
/*
  ...
  */
  ...
  std::string index_image = std::to_string(i);
  image_path = image_path + index_image +".jpg";

  myfile <<index_image<<",";



  LOG(INFO) << "---------------------- reading: " << image_path;
  ...
  */
  ...
  /*
  *   All these above needs to be in a loop...
  */
